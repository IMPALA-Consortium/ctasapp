...
You can install the development version of ctasapp from [GitHub](https://github.com/IMPALA-Consortium/ctas_app) with:
...
- **Contributor Guidelines** - Contributor guidelines including step-by-step processes for code development are provided as a [vignette](https://impala-consortium.github.io/ctas_app/articles/ContributorGuidelines.html).
